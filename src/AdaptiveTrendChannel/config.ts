...
export const config = {
  ...
  ADAPTIVE_TREND_CHANNEL_REENTRY_COOLDOWN_MS: 86_400_000,
...
export type AdaptiveTrendChannelConfig = StrategyConfig &
  Omit<typeof config, "BACKTEST_PRICE_MODE" | "LONG" | "SHORT"> & {
    ...
    ADAPTIVE_TREND_CHANNEL_EXIT_CONFIRMATION_BARS_LONG?: number;
    ADAPTIVE_TREND_CHANNEL_EXIT_CONFIRMATION_BARS_SHORT?: number;
  };
